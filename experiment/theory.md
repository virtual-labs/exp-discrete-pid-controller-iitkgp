...
$$	\begin{bmatrix} 	x_1 [k+1]  \newline	x_2 [k+1] \end{bmatrix}	= \begin{bmatrix} 	0  & T_s \newline	0 & 1-\frac{b}{J} T_s \end{bmatrix} \begin{bmatrix} 	x_1 [k] \newline	x_2 [k] \end{bmatrix} + \begin{bmatrix} 0  \newline	\frac{K}{J} T_s \end{bmatrix} u[k]	\quad	\tag{8}$$ 

<br/> Discrete State Space form with Integral state: 

$$	\begin{bmatrix} 	x_1 [k+1]  \newline	x_2 [k+1] \newline x_3[k+1] \end{bmatrix}	= \begin{bmatrix} 	0  & T_s & 0 \newline	0 & 1-\frac{b}{J} T_s & 0 \newline -T_s & 0 & 1 \end{bmatrix} \begin{bmatrix} 	x_1 [k] \newline	x_2 [k] \newline x_3[k] \end{bmatrix} + \begin{bmatrix} 0  \newline	\frac{K}{J} T_s \newline 0\end{bmatrix} u[k]	\quad	\tag{9} $$ 
